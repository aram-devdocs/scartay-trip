...
import { MapPinIcon, BuildingIcon, ClockIcon, XCircleIcon, PencilIcon, PlusIcon, CheckIcon, XIcon, TrashIcon, LoaderIcon } from '@/components/icons/Icons'
      ...
      {showAddForm && !isOffline && (
        ...
        >
          ...
          >
            ...
            {mutationState.isAdding ? 'Adding...' : 'Add Activity'}
          </button>
        </form>
      )}
              ...
              {editingId === activity.id ? (
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    >
                      {mutationState.isUpdating && mutationState.updatingId === activity.id ? <LoaderIcon size={14} /> : <CheckIcon size={14} />}
                      {mutationState.isUpdating && mutationState.updatingId === activity.id ? 'Saving...' : 'Save'}
                    </button>
                    <button
                    ...
                    >
                      {mutationState.isDeleting && mutationState.deletingId === activity.id ? <LoaderIcon size={14} /> : <TrashIcon size={14} />}
                      {mutationState.isDeleting && mutationState.deletingId === activity.id ? 'Deleting...' : 'Delete'}
                    </button>
                  </div>
                </div>
              ) : (
                  ...
                  <div className="space-y-2 text-sm" style={{ color: 'var(--text-secondary)' }}>
                    {activity.address && (
                      ...
                      >
                        ...
                        <span className="underline underline-offset-2">{activity.address}</span>
                      </a>
                    )}
